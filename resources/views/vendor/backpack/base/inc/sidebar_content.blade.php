...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('qr') }}"><i class="nav-icon la la-qrcode"></i> <span>QR</span></a></li>
<!-- <li class="nav-item"><a class="nav-link" href="{{ backpack_url('popup') }}"><i class="nav-icon la la-expand"></i> <span>Popup</span></a></li> -->
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('orders') }}"><i class="nav-icon la la-list"></i> Ventas</a></li>
