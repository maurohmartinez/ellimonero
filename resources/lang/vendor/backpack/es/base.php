...
return [
    ...
    */
    ...
    'click_here_to_reset'    => 'Restaurar la contraseña',
    ...
    'password_reset' => [
        ...
        'line_1'   => 'Ha recibido este correo electrónico porque recibimos una solicitud de restablecimiento de contraseña para su cuenta.',
        'line_2'   => 'Haga clic en el botón a continuación para restablecer su contraseña:',
        'button'   => 'Restablecer la contraseña',
        'notice'   => 'Si no solicitó un restablecimiento de contraseña, no se requiere ninguna otra acción.',
    ],

    'step'                   => 'Paso',
    'confirm_email'          => 'Confirmar email',
    'choose_new_password'    => 'Elegir contraseña nueva',
